...
class DashboardController extends Controller
{
    ...
    {
        $users = User::count();
        $total_earnings = Payment::whereHas('package',function($query) use ($request){
        ...
        $subscribers=Subscription::where('package_owner_id',auth()->user()->id);
        $teams = Team::count();
        $sports = sport::count();
        $games = Game::count();
        ...
        return view('admin.dashboard.handicapperdashboard', get_defined_vars());
    }
