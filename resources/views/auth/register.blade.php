        ...
        <div class="row justify-content-center">
            <div class="col-12 d-flex align-items-center justify-content-center">
                <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                    ...
                    <div class="text-center text-md-center mb-4 mt-md-0">
                        <br><h1 class="mt-n3 mb-0 h3">{{ __('Create Account') }}</h1>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                <input name="image" type="file" accept="image/png, image/jpeg" class="form-control" required>
                            </div>
                        </div>
                        <!-- End of Form -->
                        <div class="d-flex justify-content-between align-items-top mb-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label mb-0" for="remember">
                                    Please click here to accept the <a target="_blank" href="/terms">Terms and Conditions</a>
                                </label>
                            </div>
                        </div>
                        <div class="d-grid">
