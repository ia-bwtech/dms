        ...
        <div id="container">
            <div id="left-col">
                <div id="left-col-cont">
                    <a href="/"><img src="{{ asset('assets/images1/logo12.png') }}" width="75%;" align="Logo"
                            class="img-fluid"></a>
                    <h2>Summary</h2>
                    <div class="item">
                    </div>
            ...
            <div id="right-col">
                ...
                {{-- @if (in_array($data->user_id, [2, 10, 16]))
                    <div id="paypal-button-container"></div>
                    <!-- Sample PayPal credentials (client-id) are included -->
                    <script
                        src="https://www.paypal.com/sdk/js?client-id=AVPi1uPgYyD94us_3QG8BoolNPSc_ktpr7TrEZFaOpRSh-kNni_m-eqTLVuhtbLSl6vsxBp-jE2RiZPN&currency=USD&intent=capture"
