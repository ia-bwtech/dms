                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm">
                                <form style="display: flex;" action="{{ route('admins.sports.index') }}">
                                ...
                                <a href="{{ route('admins.sports.create') }}"><button type="button"
                                        class="btn btn-primary rounded-pill rounded-bill m-1">Add Sport</button></a>
                            </div>
                        </div>
