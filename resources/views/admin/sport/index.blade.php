...
@section('content')
            ...
            <div class="filtersdiv">
                ...
                <div class="filters row" style="display: none;">
                    ...
                    {{-- <div class="col-md-0 mx-3 my-3">
                            ...
                            <a href="{{ route('sports.index') }}"><button type="button"
            ...
            <div class="row mb-2">
                ...
                <div class=" offset-sm-2  col-sm-2">
                    <h1 class="float-sm-right"><span id="total"
                            class="badge badge-pill total">{{ $sports->total() }}</span></h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm">
                                <form style="display: flex;"  onsubmit="event.preventDefault();" action="{{ route($last[1].'.sports.index') }}">
                                ...
                                <a href="{{ route($last[1].'.sports.create') }}"><button type="button"
                                        class="btn btn-primary rounded-pill rounded-bill m-1 d-none">Add Sport</button></a>
                            </div>
                        </div>
    ...
    <script>
        ...
        function ajaxSearch(value, page, role_id) {
            $.ajax({
                type: "POST",
                url: "/admins/sportsajax" + "?page=" + page,
                dataType: 'JSON',
                headers: {
