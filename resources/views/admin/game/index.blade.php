                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm">
                                <form style="display: flex;"  onsubmit="event.preventDefault();" action="{{ route($last[1].'.games.index') }}">
                                ...
                                <a href="{{ route($last[1].'.games.create') }}"><button type="button"
                                        class="btn btn-primary rounded-pill rounded-bill m-1 d-none">Add Game</button></a>
                            </div>
                        </div>
