        ...
        <div class="row">
            ...
            <div class="col-md-12 ">
                ...
                <div class="card card-info black">
                    ...
                    <!-- form start -->
                    <div class="col-md-8 " >
                        <form action="{{ route($last[1].'.packages.update',$package->id) }}" method="POST" class="form-horizontal"
                                    ...
                                    <div class="col-sm-6">
                                        <select required class="form-control" name="user_id" id="user_id">
                                            @foreach ($users as $item)
                                                <option @if($item->id==$package->user_id) selected @endif value="{{ $item->id }}">{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
