    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="filtersdiv">
                ...
                @include('admin.layouts.date-filter', ['role' => 0, 'route' => 'emailoptionsajax','verified'=>1,'is_won'=>1,'status'=>1])
            ...
            <div class="row mb-2">
                ...
                <div class=" offset-sm-2  col-sm-2">
                    <h1 class="float-sm-right"><span id="total"
                            class="badge badge-pill total">{{ $emailoptions->total() }}</span></h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm">
                                <form style="display: flex;"  onsubmit="event.preventDefault();" action="{{ route($last[1].'.emailoptions.index') }}">
                                ...
                                {{-- <a href="{{ route($last[1].'.emailoptions.create') }}"><button type="button"
                                        class="btn btn-primary rounded-pill rounded-bill m-1 d-none">Add emailoption</button></a> --}}
                            </div>
                        </div>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody id="ajaxupdate">
                                ...
                                @include('admin.emailoption.emailoptiontable')
                            </tbody>
                        </table>
