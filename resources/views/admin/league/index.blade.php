                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm">
                                <form style="display: flex;" action="{{ route('admins.leagues.index') }}">
                                ...
                                <a href="{{ route('admins.leagues.create') }}"><button type="button"
                                        class="btn btn-primary rounded-pill rounded-bill m-1">Add League</button></a>
                            </div>
                        </div>
