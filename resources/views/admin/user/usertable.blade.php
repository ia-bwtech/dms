@forelse ($users as $item)
    <tr>
        ...
        <td><img class="rounded-circle  " style="height: 50px;width: 50px;"
                src="/images/profile/{{$item->image}}" id="dpuser"></td>
        ...
        <td>{{ $item->unverified_plays ? $item->unverified_plays : 0}}</td>
        <td>{{ $item->verified_wins ? $item->verified_wins : 0}}</td>
        <td>{{ $item->unverified_wins ? $item->unverified_wins : 0}}</td>
        ...
        <td>
            <a href="{{ route('admins.users.show', $item->id) }}" class="float-left mr-3"><i class="fas fa-eye"></i></a>
            <a href="{{ route('admins.users.edit', $item->id) }}" class="float-left"><i class="fas fa-edit"></i></a>
