...
@section('content')
                    ...
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                        <div>
                            ...
                            {{-- <div id="myModal" class="modal">
                                ...
                                <form class="" id="complain_save_profile_form1" enctype="multipart/form-data">
                            ...
                            <form class="profileform" id="complain_save_profile_form" enctype="multipart/form-data">
                                <meta name="csrf-token" content="{{ csrf_token() }}" />


                                @if (Auth::complain()->dp == null)
                                    <div class="photo-img center mt-5 rounded-circle parent" id="image_complain"
                                        style="background-image:url('{{ asset('images/complaindp/default.png') }}'); margin-top:3%">
                                    </div>
                                @else
                                    @php
                                        $complaindp = Auth::complain()->dp;
                                    @endphp
                                    <div class="photo-img center rounded-circle parent" id="image_complain"
                                        style="background-image:url('{{ asset('images/complaindp') }}/{{ $complaindp }}'); ">
                                    ...
                                    <img id="myImg" src="{{ asset('images/complaindp') }}/{{ $complaindp }}" alt=""
                                        style="display: none">
                                    <h1 class="h1profile">{{ Auth::complain()->name }}</h1>
                                    <span class="badge badge-pill"
                                        style="font-size:15px;background-color: #000305a1;color: #3f647a">{{ auth()->complain()->role->name }}</span>
                                @endif




                                {{-- <img class="rounded-circle center mt-5 " id="image_complain" name='image_complain'
                                        src="{{ asset('images/complaindp/default.png') }}" > --}}
                        ...
                        <form action="">
                            <div class="row mt-2">
                                <div class="col-md-6">
                                    <div class="text-field ">
                                        <input type="text" class="form-control" value="{{ Auth::complain()->name }}"
                                            name="name" required>
                                        <label>Name</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="text-field">
                                        <input id="email" readonly type="text" class="form-control"
                                            value="{{ Auth::complain()->email }}" required>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="text-field">
                                        <input readonly type="text" class="form-control"
                                            value="{{ Auth::complain()->phone }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="text-field">
                                        <input readonly type="text" class="form-control"
                                            value="{{ Auth::complain()->mobile }}" required>
                                ...
                                <div class="col-md-12">
                                    <div class="text-field">
                                        <textarea type="text" class="form-control" name="address"
                                            ...
                                            required>{{ Auth::complain()->address }}</textarea>
    ...
    {{-- <script>
        ...
        var img = document.getElementById("image_complain");
        ...
        // When the complain clicks on <span> (x), close the modal
        ...
        function updateRotatedImage(Img, Wow) {
            ...
            // let myForm = document.getElementById('complain_save_profile_form');
            var form_data = new FormData($('#complain_save_profile_form1')[0]);
    ...
    <script>
            ...
            if (jQuery.inArray(image_extention, ['png', 'jpg', 'jpeg']) == -
                ...
                if (input.files && input.files[0]) {
                    ...
                    reader.onload = function(e) {
                        $('#image_complain').css('background-image', 'url(' + e.target.result + ')');
                        $('#dpcomplain').prop('src', e.target.result);

                        // $("#image_complain").attr("src", '{{ asset('images/complaindp/pic') }}' );
                    };
                    reader.readAsDataURL(input.files[0]);
                    uploadComplainProfileImage();
                }
            }
            // readURL(input);
        }
        ...
        function uploadComplainProfileImage() {
            // let myForm = document.getElementById('complain_save_profile_form');
            var form_data = new FormData($('#complain_save_profile_form')[0]);
