    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="filtersdiv">
                ...
                @include('admin.layouts.date-filter', ['role' => 1, 'route' => 'cmssajax'])
            ...
            <div class="row mb-2">
                ...
                <div class=" offset-sm-2  col-sm-2">
                    {{-- <h1 class="float-sm-right"><span id="total"
                            class="badge badge-pill total">{{ $cmss->total() }}</span></h1> --}}
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm">
                                <form style="display: flex;"  onsubmit="event.preventDefault();" action="{{ route($last[1].'.cmss.index') }}">
                                ...
                                <a href="{{ route($last[1].'.cmss.create') }}"><button type="button"
                                        class="btn btn-primary rounded-pill rounded-bill m-1 d-none">Add cms</button></a>
                            </div>
                        </div>
