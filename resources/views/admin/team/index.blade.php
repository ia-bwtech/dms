...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class=" offset-sm-2  col-sm-2">
                    <h1 class="float-sm-right"><span id="total"
                            class="badge badge-pill total">{{ $teams->total() }}</span></h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm">
                                <form style="display: flex;"  onsubmit="event.preventDefault();" action="{{ route($last[1].'.teams.index') }}">
                                ...
                                <a href="{{ route($last[1].'.teams.create') }}"><button type="button"
                                        class="btn btn-primary rounded-pill rounded-bill m-1 d-none">Add Team</button></a>
                            </div>
                        </div>
    ...
    <script>
        ...
        function ajaxSearch(value, page, role_id) {
            $.ajax({
                type: "POST",
                url: "/admins/teamsajax" + "?page=" + page,
                dataType: 'JSON',
                headers: {
