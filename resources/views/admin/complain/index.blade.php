...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="filtersdiv">
                ...
                @include('admin.layouts.date-filter', ['role' => 1, 'route' => 'complainsajax'])
            ...
            <div class="row mb-2">
                ...
                <div class=" offset-sm-2  col-sm-2">
                    <h1 class="float-sm-right"><span id="total"
                            class="badge badge-pill total">{{ $complains->total() }}</span></h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm">
                                <form style="display: flex;"  onsubmit="event.preventDefault();" action="{{ route($last[1].'.complains.index') }}">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody id="ajaxupdate">
                                ...
                                @include('admin.complain.complaintable')
                            </tbody>
                        </table>
    ...
    <script>
        ...
        function ajaxSearch(value, page, role_id) {
            $.ajax({
                type: "POST",
                url: "/admins/complainsajax" + "?page=" + page,
                dataType: 'JSON',
                headers: {
