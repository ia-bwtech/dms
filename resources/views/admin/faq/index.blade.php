    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="filtersdiv">
                ...
                {{-- @include('admin.layouts.date-filter', ['role' => 1, 'route' => 'faqsajax']) --}}
            ...
            <div class="row mb-2">
                ...
                <div class=" offset-sm-2  col-sm-2">
                    <h1 class="float-sm-right"><span id="total"
                            class="badge badge-pill total">{{ $faqs->total() }}</span></h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group-sm">
                                <form style="display: flex;"  onsubmit="event.preventDefault();" action="{{ route($last[1].'.faqs.index') }}">
                                ...
                                <a href="{{ route($last[1].'.faqs.create') }}"><button type="button"
                                        class="btn btn-primary rounded-pill rounded-bill m-1">Add Faq</button></a>
                            </div>
                        </div>
